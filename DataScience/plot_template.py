...
6#las conversiones de color y las transformaciones.
...
ax2 = fig.add_subplot(1, 3, 2, adjustable='box-forced')
ax3 = fig.add_subplot(1, 3, 3, sharex=ax2, sharey=ax2, adjustable='box-forced')

ax1.imshow(coin, cmap=plt.cm.gray)
fig.savefig('imagenprueba.png')
ax1.set_axis_off()
ax1.set_title('template')

ax2.imshow(image, cmap=plt.cm.gray)
fig.savefig('imagenprueba2.png')
ax2.set_axis_off()
ax2.set_title('image')
